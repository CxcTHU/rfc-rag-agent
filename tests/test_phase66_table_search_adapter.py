...
from tests.test_agent_tools import make_session, seed_agent_tool_table_documents
...
def test_table_adapter_matches_frozen_agent_toolbox_result(tmp_path, monkeypatch) -> None:
    ...
    with TestingSessionLocal() as db:
        ...
        expected = toolbox.search_tables("mix ratio table parameters", top_k=3)
        actual = adapter.search("mix ratio table parameters", top_k=3)
